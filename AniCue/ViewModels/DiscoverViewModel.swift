...
class DiscoverViewModel: ObservableObject {
    ...
    func getRecommendations(for prompt: String) async {
        ...
        do {
            ...
            let filteredAnimes = animeList.getFilteredAnime(forGenreId: genres.first ?? 0,filterAnswers: userPreferences.selectedAnswers, numberOfResults: Constants.resultsPrompt)
            do {
